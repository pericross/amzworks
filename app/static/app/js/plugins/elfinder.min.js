(function (a) {
    elFinder = function (d, g) {
        ...
        this.checkSelectedPos = function (k) {
            var j = b.view.cwd.find(".ui-selected:" + (k ? "last" : "first")).eq(0), l = j.position(),
                i = j.outerHeight(), m = b.view.cwd.height();
            if (l.top < 0) {
...
(function (a) {
    ...
    elFinder.prototype.ui.prototype.commands = {
        back: function (c) {
            ...
            this.exec = function () {
                b.fm.unselectAll();
                var i = this.fm.uniqueName("untitled file", ".txt"), e = a('<input type="text"/>').val(i),
                    h = {name: i, hash: "", mime: "text/plain", read: true, write: true, date: "", size: 0},
            ...
            this.exec = function () {
                ...
                function n() {
                    var v = a('<iframe name="' + g + '" name="' + g + '" src="about:blank"/>'), w = v[0], i = 50, u, e,
                        t;
                    v.css({
                        position: "absolute",
                        top: "-1000px",
...
(function (a) {
    elFinder.prototype.quickLook = function (l, b) {
        ...
        this.win = a('<div class="el-finder-ql"/>').hide().append(a('<div class="el-finder-ql-drag-handle"/>').append(a('<span class="ui-icon ui-icon-circle-close"/>').click(function () {
            p.hide()
        })).append(this.title)).append(this.ico).append(this.media).append(this.content.append(this.name).append(this.kind).append(this.size).append(this.date).append(this.url).append(this.add)).appendTo("body").draggable({handle: ".el-finder-ql-drag-handle"}).resizable({
            minWidth: 420,
            minHeight: 150,
            resize: function () {
                if (p.media.children().length) {
                    ...
                    switch (m[0].nodeName) {
                        case"IMG":
                            var e = m.width(), n = m.height(), i = p.win.width(),
    ...
    elFinder.prototype.quickLook.prototype.plugins = {
        image: new function () {
            ...
            this.show = function (e, d) {
                ...
                function g(k) {
                    var j = k.width(), m = k.height(), i = e.win.is(":animated"), l = i ? 420 : e.win.width(),
                    ...
                    e.ico.hide();
                    k.css({width: e.ico.width(), height: e.ico.height()}).show().animate({
    ...
    elFinder.prototype.eventsManager = function (d, c) {
        ...
        this.init = function () {
            ...
            this.cwd.bind("click", function (j) {
                ...
                filter: "[key]", delay: 300, stop: function () {
                    g.fm.updateSelect();
                    g.fm.log("mouseup")
                }
            });
            ...
            if (this.fm.options.places) {
                ...
                this.fm.view.plc.droppable({
                    accept: "(div,tr).directory", tolerance: "pointer", over: function () {
        ...
        this.updateCwd = function () {
            a("[key]", this.cwd).bind("dblclick", function (g) {
                ...
                delay: 3, addClasses: false, appendTo: ".el-finder-cwd", revert: true, drag: function (h, g) {
                ...
                tolerance: "pointer", accept: "div[key],tr[key]", over: function () {
                    a(this).addClass("el-finder-droppable")
                }, out: function () {
                    a(this).removeClass("el-finder-droppable")
                }, drop: function (h, g) {
